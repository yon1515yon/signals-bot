...
class ForecastMetricsResponse(BaseModel):
    ...
    multi_horizon_forecast: Optional[dict] = None
...
# Исправлено: наследование от PositionBase напрямую, без префикса schemas.
class LocalTradeRequest(PositionBase):
    ticker: str
    price: float
    direction: str = "LONG"
    amount: float = 50000